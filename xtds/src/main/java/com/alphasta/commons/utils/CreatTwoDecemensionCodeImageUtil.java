...
public class CreatTwoDecemensionCodeImageUtil {
	...
	public static void main(String[] args) {
		...
		// ctdciu.encoderQRCode("http://cloud.mail.163.com/dfs/service/5.16.apk",
		// "E:/aaa.jpg", imgType, size);
		ctdciu.encoderQRCode("http://180.76.235.249:8090/shiro/files/hsds.apk",
				"E:/hsds0.jpg", imgType, size);
	}
}