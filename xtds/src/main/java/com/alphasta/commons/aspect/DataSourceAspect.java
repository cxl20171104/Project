...
import com.alphasta.commons.datasource.DynamicDataSource;
import com.alphasta.commons.exception.DataSourceAspectException;
...
/**
 * 有{@link com.alphasta.commons.annotation.DataSourceChange}注解的方法，调用时会切换到指定的数据源
 * 
 * @author tanghd
 */
@Aspect
public class DataSourceAspect {
	...
	@Pointcut(value = "@annotation(com.alphasta.commons.annotation.DataSourceChange)")
