...
public class SchoolModel implements Serializable {
	...
	public String toString() {
		return "SchoolModel [id=" + id + ", schoolName=" + schoolName
				+ ", schoolCode=" + schoolCode + ", schoolAddress="
				+ schoolAddress + ", schoolCost=" + schoolCost + ", schoolUrl="
				+ schoolUrl + ", schoolNum=" + schoolNum + ", low2015="
				+ low2015 + ", low2014=" + low2014 + ", low2013=" + low2013
