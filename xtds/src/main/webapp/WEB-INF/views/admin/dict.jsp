...
<body class="easyui-layout">
   ...
   <div data-options="region:'west',split:false,border:false" style="width:50%;border-right:1px solid #d3d3d3">
    	<ul id="dictTree"></ul>
    </div>
	<div data-options="region:'center',fit:true,border:false" >
		<form id="dictForm">
			...
			<table class="formTable"  style="width:40%">
				<tr>
					<th>上级字典：</th>
					<td><input type="text" class="easyui-textbox" data-options="width:'200px'" id="dictPname" name="dictPname" /></td>
				</tr>
				<tr>
					<th>字典名称：</th>
					<td><input type="text" class="easyui-textbox" data-options="width:'200px',required:true" id="name" name="name" /></td>
				</tr>
				<tr>
					<th>字典值：</th>
					<td><input type="text" class="easyui-textbox" data-options="width:'200px',required:true" id="value" name="value" /></td>
				</tr>
				<tr>
					<th>备注：</th>
