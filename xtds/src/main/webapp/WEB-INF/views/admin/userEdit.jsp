        	...
        	<table class="formTable">
                ...
                <tr>
                    ...
                    <td><input type="text" name="age" class="easyui-numberbox" data-options="width:'100%'" value="${user.age }" /></td>
                                ...
                                <tr>
                    <th>学历:</th>
                    <td><input id="xue_li" class="easyui-combobox"  name="xue_li" value="${user.xue_li}"
                    ...
                    <th>学位:</th>
                    <td>
                    <input class="easyui-combobox" name="xue_wei" value="${user.xue_wei}" data-options="panelHeight:100,
									valueField: 'id',
									textField: 'text',
									data: [{
										text: '学士',
                ...
                <tr>
                 ...
                 <th>入党日期：</th>
                    <td>
                        <input name="intime" type="text" class="easyui-datebox" data-options="width:'100%'" value="${user.intime}"></input>                          
                    </td> 
                    <th>邮箱：</th>
                    <td>
                 ...
                 <tr>
                    <th>特长:</th>
                    <td>
                     <input id="love" name="love" value="${user.love}" class="easyui-combobox"  
                     ...
                     " /> 
                       ...
                       <th>App排序:</th>
                       <td><input type="text" name="seq" value="${user.seq}" class="easyui-textbox" data-options="width:'100%'" /> </td>
                </tr>
                <tr>
                    <th>承诺:</th>
                    <td >
                          <input name="motto" class="easyui-textbox" data-options="multiline:true,fit:true" value="${user.motto}" />                      
                    </td>                 
                </tr>  
            </table>
        </form>
