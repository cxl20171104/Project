...
$(function() {
        ...
        dataGrid =	$('#dataGrid').datagrid({
            ...
            pagination : true,
            singleSelect : true,
            queryParams: { pageName: $("#pageName").val(),zddb:$("#zddb").val(),id:$("#cluesId").val(),},    
            selectOnCheck : false,
            checkOnSelect : false,
            border : false,
            ...
            columns : [ [ {
            	...
            	formatter:function(value,row,index){ 
            		...
            		return '<button onclick="cancelRepeat('+index+');">解除重复关系</button>'
            	}
            },{//（新添加）
            	title:"操作",
            	field:"work",
...
//重复件操作列表
function cancelRepeat(index){
	  var rows = $('#dataGrid').datagrid('getRows');
	  var row = rows[index];
	  var id = row.id;
	  $.getJSON(path+"/repeat/cancelRepeat?id="+id,function(req){
