            ...
            loadFilter: function(data){
            	...
            	if (data.rows) {
	            	for (var i = 0; i < data.rows.length; i++) {
		            	...
		            	/*console.log("ddddd"+data.rows[i].isImport);
		            	if(data.rows[i].isImport=="1"){
		            		data.rows[i].reflectedName = data.rows[i].reflectedPerson.reflectedName+"(重要)";
		            		alert(data.rows[i].reflectedName);
		            	}*/
	            	}
