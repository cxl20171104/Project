...
<div class="easyui-layout" data-options="fit:true,border:false">
   <form id="my_form" method="post">
           	...
           	<input type="hidden"  name="type" value="安管呈批签" />
        <table class="formTable">
              <tr>
	    		<th>标题：</th>
	    		<td colspan="2"><input type="text" class="easyui-textbox" data-options="width:'80%',required:true" id="title" name="title" /></td>  
	    	  </tr>
	    	  <tr> 
	    		<th>名称：</th>
	    		<td colspan="2"><input type="text" class="easyui-textbox" data-options="width:'80%',required:true" id="name" name="name" /></td>  
	    	 </tr>
	    	    <tr>
					<th>附件： </th>
					<td>
