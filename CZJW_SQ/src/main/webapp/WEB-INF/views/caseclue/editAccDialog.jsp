...
<div class="easyui-layout" data-options="fit:true,border:false">
   <form id="my_form" method="post">
        ...
        <table class="formTable">
              <tr>
	    		<th>标题：</th>
	    		<td colspan="2"><input type="text" class="easyui-textbox" data-options="width:'80%',required:true" id="title" name="title"  value="${acc.title }"/></td>  
	    	  </tr>
	    	  <tr> 
	    		<th>名称：</th>
	    		<td colspan="2"><input type="text" class="easyui-textbox" data-options="width:'80%',required:true" id="name" name="name"    value="${acc.name }"/></td>  
	    	 </tr>
	    	  <tr> 
	    		<th >分类：</th>
	    		<td colspan="2"><input type="text" class="easyui-textbox" data-options="width:'80%',required:true" id="content" name="content" value="${acc.content }" /></td>  
	    	 </tr>
