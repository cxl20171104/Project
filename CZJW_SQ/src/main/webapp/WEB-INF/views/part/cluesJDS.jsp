...
<button id="save1" type="button" class="btn btn-default" onclick="save_clues();">保存(JD)</button>
</c:if>
...
<td><input id='birthday' type="text" name="reflectedPerson.birthday" placeholder="格式:2018-06" value="${problemClues.reflectedPerson.birthday}" style="width:300px;height:45px;"></input>  
...
<td><input id="workPosition" type="text" class="easyui-textbox"
								...
								value="${problemClues.reflectedPerson.workPosition}" style="width:300px;height:45px;" required=required></td>
</tr>
<tr>
...
<td><input id="duty" type="text" class="easyui-textbox" placeholder="请输入名称"
								...
								value="${problemClues.reflectedPerson.duty}" style="width:300px;height:45px;" required="required"></td>
...
<td><select id="eightSpirit" name="reflectedPerson.eightSpirit" class="easyui-combobox" style="width:300px;height:45px;" validType="comboxValidate['eightSpirit','该项为必选项']">
								<option value="0">请选择</option>
...
<td><select id="problemLand" name="problemLand" class="easyui-combobox" style="width:300px;height:45px;" validType="comboxValidate['problemLand','该项为必选项']">
								<option value="0">请选择</option>
...
<td><select id="fields" name="fields"  style="width:300px;height:45px;"  class="easyui-combobox" validType="comboxValidate['fields','该项为必选项']"></select></td>
...
<td><select id="isResult" name="isResult" class="easyui-combobox"  style="width:300px;height:45px;"
								onChange="return isResult2()" validType="comboxValidate['isResult','该项为必选项']">
								    <option value="0">请选择</option>
									<option	<c:if test="${'1' ==problemClues.isResult}"> selected="selected" </c:if> value="1">是</option>
									<option <c:if test="${'2' ==problemClues.isResult}"> selected="selected" </c:if> value="2">否</option>
							</select></td>
...
<td colspan="7" class="box2">
<textarea name="remarks"  id="remarks" class="form-control" rows="3" cols="120">${problemClues.remarks}</textarea>
</td>
</tr>  
<tr><th>反映人信息</th></tr>
<tr><td><label class="col-md-1 control-label">反映人姓名</label></td>
<td><input id="reflectingName"
...
<td><input type="text" class="form-control" id="reflectingDept"
...
<td><input type="text" class="form-control" id="tell"
...
function transfer(){
	   ...
	   $.ajax({
		   ...
		   $.messager.alert('我的消息','请先添加线索！','warning');
	   }
}
function addRepeat(){
