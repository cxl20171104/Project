...
<button id="save2" type="button" class="btn btn-default" onclick="save_clues();" >保存(SL)</button>
</c:if>
...
<td><input type="text" class="easyui-textbox"  id="identificationNumber"
								...
								value="${problemClues.reflectedPerson.identificationNumber}" style="width:300px;height:45px;" data-options="validType:'idcard'"/></td>
...
<td><input type="text" class="easyui-textbox" id="workPosition"
...
<td><input type="text" class="easyui-textbox" placeholder="请输入名称" id="duty"
...
<td><select class="easyui-combobox" id="natureOfenterprise"
...
<td><select class="easyui-combobox" id="classOfenterprise"
...
<td><label class="col-md-2 control-label"><span style="color: red; font-size: 22px">*</span>党委委员</label></td>
<td><select class="easyui-combobox" id="dwMember" name="reflectedPerson.dwMember" style="width:300px;height:45px;" validType="comboxValidate['dwMember','该项为必选项']">
								<option value="0">请选择</option>
...
<td><label class="col-md-2 control-label"><span style="color: red; font-size: 22px">*</span>纪委委员</label></td>
<td><select class="easyui-combobox" id="jwMember" name="reflectedPerson.jwMember" style="width:300px;height:45px;" validType="comboxValidate['jwMember','该项为必选项']">
								<option value="0">请选择</option>
...
<td><select id="eightSpirit" id="eightSpirit" name="reflectedPerson.eightSpirit" class="easyui-combobox" style="width:300px;height:45px;" >
								<option value="0">请选择</option>
...
<td colspan="7" class="box2"><textarea id="problemDescribe" name="problemDescribe" cols="120"  rows="3" >${problemClues.problemDescribe}</textarea></td> 
</tr>
 <tr>
...
<td><input type="text" id="tell"
	name="reflectingPerson.tell" placeholder="请输入联系方式"
	value="${problemClues.reflectingPerson.tell}" class="easyui-textbox"  
	style="width:300px;height:45px;" 
...
$(function(){
	...
	if(pageName=="overing"&&pageName=="working"&&pageName=="library"&&pageName=="AGSZAIBAN"){		
		$('input,textarea',$('form[name="cluesForm"]')).attr('readonly',true);
		 $('.easyui-combobox').combobox({ 
			 readonly:true  
       }); 
		 $('.easyui-datebox').combobox({ 
			 readonly:true  
       }); 
	}
});
