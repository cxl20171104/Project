...
<form id="cluesForm" name="cluesForm" >
	                        ...
	                        <input type="hidden"  id="state" name="state" value="${problemClues.state}" /> 
...
<button id="save2" type="button" class="btn btn-default" onclick="save_clues('CLUESLC');">保存(AG)</button></td>
</c:if>
<c:if test="${fn:contains(roleId,'18')!=false||(flag==null||flag=='')&&(pageName=='having'||pageName=='initial'||pageName=='returnList')||pageName=='newClues'||pageName=='tongan'}">
...
<c:if test="${fn:contains(roleId,'18')!=false||(pageName=='newClues'||pageName=='having')&&organId!='11'}">
<button id="fh" type="button" class="btn btn-default" onclick="transfer();">转发案管室</button>
</c:if>	
<table class="cxl">
...
<select id="mz" class="easyui-combobox" name="reflectedPerson.nation" style="width:300px;height:45px;">
							</select></td>
<td><label>证件类型</label></td>
<td><select id="documentType"  name="reflectedPerson.documentType"  class="easyui-combobox" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><input type="text" class="easyui-textbox"  id="identificationNumber"
								...
								value="${problemClues.reflectedPerson.identificationNumber}" style="width:300px;height:45px;"/></td>




<td><label >出生年月</label></td>
<td><input type="text" name="reflectedPerson.birthday" placeholder="格式:2018-06" value="${problemClues.reflectedPerson.birthday}" style="width:300px;height:45px;"></input>  
...
<td><input id="workPosition" type="text" class="easyui-textbox"
...
<td><input id="duty" type="text" class="easyui-textbox" placeholder="请输入名称"
...
<td>
<select id="rank" class="easyui-combobox" name="reflectedPerson.rank"  style="width:300px;height:45px;" validType="comboxValidate['rank','该项为必选项']">
					<option value="0">请选择</option>
...
<td><label class="col-md-2 control-label">任现职时间</label></td>
<td><input id="worktime" type="text" name='reflectedPerson.worktime' placeholder="格式:2018-06"  value="${problemClues.reflectedPerson.worktime}" style="width:300px;height:45px;" ></input>  
...
<tr>
<td><label class="col-md-1 control-label">政治面貌</label></td>
<td>
<select class="easyui-combobox" id="political" name="reflectedPerson.political"  style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><label class="col-md-2 control-label">入党时间</label></td>
<td><input id="intime" type="text" name='reflectedPerson.intime' placeholder="格式:2018-06" value="${problemClues.reflectedPerson.intime }" style="width:300px;height:45px;" ></input>  
</td>
<td>反映违纪行为</td>	
	   <td>
...
<tr>
<td><label class="col-md-1 control-label">身份</label></td>
<td><select id="civilServant" class="easyui-combobox" name="reflectedPerson.civilServant" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><label class="col-md-2 control-label">部门分类</label></td>
<td><select id="departmenType" class="easyui-combobox" name="reflectedPerson.departmenType" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><select id="natureOfenterprise" class="easyui-combobox"
...
<td><select id="classOfenterprise" class="easyui-combobox"
...
<td><select id="post" class="easyui-combobox" name="reflectedPerson.post" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><select id="posType" class="easyui-combobox" name="reflectedPerson.posType" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><label class="col-md-1 control-label">一把手违纪违法</label></td>
<td><select id="topDiscipline" class="easyui-combobox" name="reflectedPerson.topDiscipline" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><label class="col-md-2 control-label">干部管理权限</label></td>
<td><select id="cadre" class="easyui-combobox" name="reflectedPerson.cadre" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<tr>
<td><label class="col-md-2 control-label">中共党代表</label></td>
<td><select id="partyRepresent" class="easyui-combobox" name="reflectedPerson.partyRepresent" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><label class="col-md-1 control-label">人大代表</label></td>
<td><select id="np" class="easyui-combobox" name="reflectedPerson.np" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><select id="dwMember" class="easyui-combobox" name="reflectedPerson.dwMember" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td><select id="jwMember" class="easyui-combobox" name="reflectedPerson.jwMember" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<tr>
<td><label class="col-md-1 control-label">政协委员</label></td>
<td><select id="zx" class="easyui-combobox" name="reflectedPerson.zx" style="width:300px;height:45px;">
								<option value="0">请选择</option>
...
<td>
<select id="isPMSupervisoryObject" name="reflectedPerson.isPMSupervisoryObject" style="width:300px;height:45px;" class="easyui-combobox"  data-options="onSelect: function(rec){    
            isP(rec.value)  
            }" />
								<option <c:if test="${'0' ==problemClues.reflectedPerson.isPMSupervisoryObject}"> selected="selected" </c:if> value="0">请选择</option>
								<option <c:if test="${'1' ==problemClues.reflectedPerson.isPMSupervisoryObject}"> selected="selected" </c:if> value="1">是</option>
								<option <c:if test="${'2' ==problemClues.reflectedPerson.isPMSupervisoryObject}"> selected="selected" </c:if> value="2">否</option>
							</select>
							</td>
<td>非党员非监察对象类型</td>
...
<td><label class="col-md-2 control-label"> <span style="color: red; font-size: 22px">*</span>受理日期</label></td>
...
<textarea id="problemDescribe" name="problemDescribe">${problemClues.problemDescribe}</textarea></td> 
</tr>
 <tr>
<td><label >备注</label></td>
<td colspan="7" class="box2">
<textarea id="remarks"  name="remarks"  >${problemClues.remarks}</textarea>
</td>
</tr>  
<tr><th>反映人信息</th></tr>
<tr><td><label class="col-md-1 control-label">反映人姓名</label></td>
<td><input id="reflectingName"  name="reflectingPerson.reflectingName" placeholder="请输入名称" value="${problemClues.reflectingPerson.reflectingName}" class="easyui-textbox"  style="width:300px;height:45px;" ></td>
<td><label class="col-md-2 control-label">反映人单位</label></td>
<td><input id="reflectingDept" type="text" class="form-control" name="reflectingPerson.reflectingDept" placeholder="请输入单位"
...
<td><input id="tell" type="text" class="form-control"
								name="reflectingPerson.tell" placeholder="请输入联系方式"
								value="${problemClues.reflectingPerson.tell}" class="easyui-textbox"  style="width:300px;height:45px;"data-options="validType:'phone'">  
