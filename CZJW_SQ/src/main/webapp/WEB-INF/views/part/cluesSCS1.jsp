...
<button id="save2" type="button" class="btn btn-default" onclick="save_clues();" >保存(SC)</button>
</c:if>
...
<td><label class="col-md-1 control-label"> 职级</label></td>
<td>
<select id="rank" class="easyui-combobox" name="reflectedPerson.rank" onChange="check('rank','choice');" style="width:300px;height:45px;" >
								<option value="0">请选择</option>
