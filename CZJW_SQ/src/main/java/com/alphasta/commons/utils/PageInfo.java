...
public class PageInfo {
    ...
    @JsonIgnore//此注解是类注解，作用是json序列化时将java bean中的一些属性忽略掉，序列化和反序列化都受影响。
    private int from;
    @JsonIgnore
    private int size;
    @JsonIgnore
    ...
    private String whichDataSource;
    public PageInfo() {
    }
	...
	public void setSqlStore(String sqlStore) {
		this.sqlStore = sqlStore;
	}

	public String getWhichDataSource() {
		return whichDataSource;
	}

	public void setWhichDataSource(String whichDataSource) {
		this.whichDataSource = whichDataSource;
	}
	...
	public String toString() {
		return "PageInfo [total=" + total + ", rows=" + rows + ", from=" + from + ", size=" + size + ", nowpage="
				...
				+ order + ", sqlStore=" + sqlStore + ", whichDataSource=" + whichDataSource + "]";
	}
